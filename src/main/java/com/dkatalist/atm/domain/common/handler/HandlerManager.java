...
public interface HandlerManager {
    ...
    public <TRequest extends RequestWithException<TResult, TException>, TResult, TException extends ATMException> HandlerManager registerHandler(HandlerWithException<TRequest, TResult, TException> handler);
}
