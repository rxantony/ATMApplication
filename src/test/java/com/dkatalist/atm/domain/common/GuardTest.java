...
public class GuardTest {
    ...
    void validateArgThrownIllegalArgumentException(Object arg, String argName) {
        assertThrows(IllegalArgumentException.class, () -> Guard.validateArgNotNull(arg, argName));
    }
    ...
    void validateArgNotNullOrEmptyThrownIllegalArgumentException(String arg, String argName) {
        assertThrows(IllegalArgumentException.class, () -> Guard.validateArgNotNullOrEmpty(arg, argName));
    }
    ...
    void validateArgMustBeGreaterThanThrownIllegalArgumentException(int arg, int reff, String argName) {
        assertThrows(IllegalArgumentException.class, () ->Guard.validateArgMustBeGreaterThan(arg, reff, argName));
    }
}
